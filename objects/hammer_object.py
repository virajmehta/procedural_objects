...
MIN_HANDLE_LENGTH=12e-2
MAX_HANDLE_LENGTH=28e-2
MIN_HANDLE_WIDTH=2e-2
MAX_HANDLE_WIDTH=5e-2
MIN_HANDLE_DEPTH=2e-2
MAX_HANDLE_DEPTH=5e-2
MIN_HEAD_LENGTH=10e-2
MAX_HEAD_LENGTH=20e-2
MIN_HEAD_WIDTH=3e-2
MAX_HEAD_WIDTH=6e-2
MIN_HEAD_DEPTH=3e-2
MAX_HEAD_DEPTH=6e-2
    ...
    def __init__(self, parts=None, tilt_prob=0.7, max_tilt=20):
        ...
        self.handle_parts = [ConvexPart(min_length=MIN_HANDLE_LENGTH,
                             ...
                             RoundPart(min_length=MIN_HANDLE_LENGTH,
                                       ...
                                       min_depth=MIN_HANDLE_WIDTH,
                                       max_depth=MAX_HANDLE_WIDTH),
        ...
        self.head_parts = [ConvexPart(min_length=8e-2,
                             ...
                             RoundPart(min_length=MIN_HEAD_LENGTH,
                                       ...
                                       min_depth=MIN_HEAD_WIDTH,
                                       max_depth=MAX_HEAD_WIDTH),
